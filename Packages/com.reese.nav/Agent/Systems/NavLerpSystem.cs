        ...
        protected override void OnUpdate()
        {
            ...
            Entities
                    ...
                    ref Rotation rotation, in Parent surface) =>
                {
                    ...
                    translation.Value += heading * agent.TranslationSpeed * deltaSeconds;

                    // Without flocking
                    // translation.Value = Vector3.MoveTowards(translation.Value, pathBuffer[pathBufferIndex].Value,
                    //     agent.TranslationSpeed * deltaSeconds);
